...
const SAMPLES = [
  ...
  ["Géométrie — Thalès", { type: "numeric", chapter: "Automatismes — Théorème de Thalès", prompt: "Deux droites sont parallèles. Les rapports correspondants donnent \\(x/6=4/3\\). Calcule x.", answer: 8, steps: ["Les côtés correspondants sont écrits dans le même ordre.", "\\(x=6\\times4\\div3=8\\)."] }, "4,5"],
