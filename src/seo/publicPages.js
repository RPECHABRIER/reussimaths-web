...
export const PUBLIC_COURSES = [
  {
    ...
    h1: "Fractions en 6e : comprendre, comparer et s’entraîner",
    ...
    rules: [
      ...
      { title: "Sur une droite graduée", text: "Pour placer une fraction, on partage chaque unité en autant de parts égales que l’indique le dénominateur, puis on compte le nombre de parts donné par le numérateur." },
      { title: "Fraction et unité", text: "Une fraction est inférieure à 1 si son numérateur est plus petit que son dénominateur, égale à 1 s’ils sont égaux, et supérieure à 1 si le numérateur est plus grand." },
    ],
    exercises: [
      ...
      { question: "La fraction 9/7 est-elle inférieure ou supérieure à 1 ?", answer: "9/7 est supérieure à 1, car le numérateur 9 est plus grand que le dénominateur 7." },
    ],
    relatedLinks: [
      { label: "Fractions en 5e", path: "/cours/cinquieme/fractions" },
      { label: "Programme de maths 6e", path: "/niveau/sixieme" },
    ],
  },
  {
    levelId: "cinquieme",
    ...
    h1: "Fractions en 5e : simplifier, comparer et calculer",
    ...
    rules: [
      ...
      { title: "Simplifier", text: "Pour simplifier une fraction, on divise son numérateur et son dénominateur par un diviseur commun, puis on recommence si nécessaire." },
      { title: "Comparer", text: "On peut comparer deux fractions en les écrivant avec un même dénominateur ou en les repérant par rapport à des nombres simples comme 0, 1 ou 1/2." },
    ],
    exercises: [
      ...
      { question: "Compare 7/8 et 5/8.", answer: "7/8 > 5/8 : les dénominateurs sont identiques et 7 > 5." },
    ],
    relatedLinks: [
      { label: "Fractions en 6e", path: "/cours/sixieme/fractions" },
      { label: "Proportionnalité en 5e", path: "/cours/cinquieme/proportionnalite" },
      { label: "Programme de maths 5e", path: "/niveau/cinquieme" },
    ],
  },
  {
    levelId: "quatrieme",
    ...
    intent: "calcul littéral 4e",
    title: "Calcul littéral en 4e : cours et exercices corrigés",
    h1: "Calcul littéral en 4e : réduire, développer et calculer",
    ...
    rules: [
      ...
      { title: "Substituer une valeur", text: "Pour calculer une expression, on remplace chaque occurrence de la lettre par la valeur donnée en conservant les priorités de calcul." },
      { title: "Tester une égalité", text: "Pour savoir si une égalité est vraie pour une valeur donnée, on calcule séparément les deux membres puis on compare leurs résultats." },
    ],
    exercises: [
      { question: "Réduis 7x + 2x − 4.", answer: "9x − 4." },
      { question: "Développe 3(x + 5).", answer: "3x + 15." },
      { question: "Calcule 2x + 7 pour x = 4.", answer: "2 × 4 + 7 = 15." },
      { question: "L’égalité 3x + 1 = 10 est-elle vraie pour x = 3 ?", answer: "Oui : 3 × 3 + 1 = 10, qui est égal au second membre." },
    ],
    relatedLinks: [
      { label: "Calcul littéral en 3e", path: "/cours/troisieme/calcul-litteral" },
      { label: "Programme de maths 4e", path: "/niveau/quatrieme" },
    ],
  },
  {
    levelId: "quatrieme",
    ...
    intent: "théorème de Pythagore 4e",
    title: "Théorème de Pythagore en 4e : cours et exercices corrigés",
    h1: "Théorème de Pythagore en 4e : méthode et exercices corrigés",
    ...
    rules: [
      ...
      { title: "Calculer l’hypoténuse", text: "On additionne les carrés des deux côtés de l’angle droit, puis on prend la racine carrée du résultat." },
      { title: "Calculer un côté de l’angle droit", text: "On soustrait le carré de l’autre côté au carré de l’hypoténuse, puis on prend la racine carrée du résultat positif." },
    ],
    exercises: [
      ...
      { question: "Un triangle de côtés 5 cm, 6 cm et 8 cm est-il rectangle ?", answer: "Non : 8² = 64 tandis que 5² + 6² = 61. Les deux résultats ne sont pas égaux." },
    ],
    relatedLinks: [
