...
`calcul-numerique.js` fait. **Prochaine étape : `proportionnalite-cinquieme.js`**
...
La partie géométrie de la 5e est terminée. `statistiques-probabilites.js` commit `4b159ba`. Prochaine étape :
