...
const SHOWCASES = {
  ...
  "terminale-techno": [
    ...
    n("Probabilités conditionnelles — Probabilité conditionnelle", "On donne \\(P(A\\cap B)=0{,}18\\) et \\(P(A)=0{,}6\\). Calcule \\(P_A(B)\\).", 0.3, s("On connaît \\(P(A\\cap B)=0{,}18\\) et \\(P(A)=0{,}6\\).", "Lorsque \\(P(A)\\) n’est pas nulle, \\(P_A(B)=\\dfrac{P(A\\cap B)}{P(A)}\\). Elle mesure la part des cas où \\(B\\) se réalise parmi ceux où \\(A\\) est réalisé.", "On calcule \\(P_A(B)=0{,}18\\div0{,}6=0{,}3\\). On vérifie que \\(0{,}6\\times0{,}3=0{,}18\\).", "La probabilité conditionnelle \\(P_A(B)\\) vaut \\(0{,}3\\), soit 30 %.")),
...
export function getDiscoveryShowcase(levelId) {
  ...
  return {
    meta: {
      ...
      level: levelId,
      title: levelId === "troisieme" ? "Les essentiels de 3e et du brevet" : "Les essentiels du niveau",
      description: "Cinq questions choisies, chacune accompagnée d’une méthode, d’une correction animée et d’un contrôle du résultat.",
      free: true,
      order: 0,
    },
