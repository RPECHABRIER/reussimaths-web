...
`calcul-numerique.js` fait. **Prochaine étape : `fonctions.js`**
...
La partie géométrie de la 5e est terminée. `statistiques-probabilites.js` commit `4b159ba`. `proportionnalite-cinquieme.js` commit `1d42250`. Prochaine étape :
`fonctions.js`.
