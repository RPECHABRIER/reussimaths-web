const PROFILES = {
  ...
  "automatismes-sixieme": {
    ...
    skills: [
      ...
      [/addition|soustraire|multiplier|diviser|calcul|table|décimal|arrondir/i, "Estime le résultat avant de calculer.", "Pose mentalement l’opération dans le bon ordre, puis contrôle avec ton estimation."],
    ],
  ...
  "automatismes-cinquieme": {
    ...
    skills: [
      ...
      [/angle|triangle|disque|aire|volume|segment|symétrie|géométrie/i, "Identifie la propriété ou la formule utile.", "Remplace les données dans la relation choisie et conserve l’unité."],
      [/probabilit|fréquence|moyenne|statistique|données/i, "Compte les cas ou les valeurs utiles.", "Choisis le bon total de référence puis calcule le rapport demandé."],
      [/calcul|décim|puissance|divis|produit|somme|équation|formule/i, "Repère l’opération prioritaire.", "Effectue une étape courte, puis vérifie le signe et l’ordre de grandeur."],
    ],
  ...
  "nombres-relatifs-quatrieme": {
    ...
    skills: [
      ...
      [/multiplier|diviser|signe d'un produit|signe d'un quotient/i, "Compte les facteurs négatifs.", "Un nombre pair de signes négatifs donne un résultat positif ; un nombre impair donne un résultat négatif."],
