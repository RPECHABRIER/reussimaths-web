...
`calcul-numerique.js` fait. **Prochaine étape : `nombres-relatifs.js`** (géométrie — figures requises, réutiliser `buildGraduatedLineFigure`)
...
`514a805`). Prochaine étape : `nombres-relatifs.js` (géométrie, figures
requises, réutiliser buildGraduatedLineFigure).
