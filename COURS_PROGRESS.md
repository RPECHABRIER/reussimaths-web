...
**Prochain chapitre à traiter : `distances-symetries.js` (6e, géométrie —
figures requises)**, puis `angles.js`, `configurations-geometriques.js`,
...
`990e34d`) et `grandeurs-mesures.js` (commit `4e99276`) faits.
