...
export default function FeedbackVisual({ family, exercise }) {
  ...
  if (family === "geometry_dot_product") {
    return <div className="mt-4 rounded-xl bg-white p-3" style={{border:`1px solid ${colors.gold}35`}}><p className="text-xs font-bold" style={{color:colors.ink}}>Produit scalaire nul : angle droit</p><svg viewBox="0 0 240 115" className="mt-2 w-full" role="img" aria-label="Deux vecteurs orthogonaux"><line x1="55" y1="88" x2="205" y2="88" stroke={colors.gold} strokeWidth="5"/><line x1="55" y1="88" x2="55" y2="18" stroke={colors.green} strokeWidth="5"/><path d="M55 72 H71 V88" fill="none" stroke={colors.ink} strokeWidth="3"/><circle cx="55" cy="88" r="5" fill={colors.ink}/><text x="118" y="80" fontSize="12" fill={colors.ink}>u</text><text x="64" y="44" fontSize="12" fill={colors.ink}>v</text></svg><p className="text-[11px] text-center" style={{color:colors.slate}}>Pour deux vecteurs non nuls, u · v = 0 signifie qu’ils sont orthogonaux.</p></div>;
  }
